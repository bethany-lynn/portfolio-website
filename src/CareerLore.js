  ...
  return (
    <div className='career-lore-body'>
      ...
      <div className="career-information">
        ...
        <br />
        So I took a big chance after 13 years doing hair, moved to California from Illinois, and decided
        to start teaching myself how to code before joining a bootcamp!
        <br />
        <br />
        I loved the idea of working remotely, especially as an introvert, and the endless possibilities
        that come with working in tech. Job assurance is essentially built-in.
        <br />
        I enjoy coding, and I really enjoy the idea of using my skills and knowledge to create my actual dream
      ...
      <div className="career-goals">
        ...
        <br />
        but to me, we should use work as a jumping point to really invest in our personal lives and what brings us joy.
        <br />
        <br />
        For some people, that is work. For me, that looks like a lot of time enjoying a cup of tea in nature, with my dog,
        <br /> 
        maybe by a bonfire, and seeing all corners of the world.
        <br />
